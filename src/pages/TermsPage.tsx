...
const sections = [
  {
    title: "١. قبول الشروط",
    body: "باستخدامك موقع رقيم وشرائك أيًا من منتجاتنا الرقمية، فإنك توافقين على الالتزام بهذه الشروط والأحكام.",
  },
  {
  ...
  },
  {
    ...
    body: "جميع المحتويات المنشورة على هذا الموقع، بما في ذلك النصوص والتصاميم والصور، محمية بحقوق الملكية الفكرية لصالح رقيم ومؤلفيها، ويُمنع إعادة نشرها أو توزيعها دون إذن كتابي.",
  },
  {
    title: "٤. سياسة الاسترجاع",
    body: "نظرًا لطبيعة المنتجات الرقمية، تُراجع طلبات الاسترجاع أو الاستبدال كل حالة على حدة وفقًا للسياسة المعتمدة لدى رقيم.",
  },
  {
    title: "٥. تعديل الشروط",
    body: "تحتفظ رقيم بحق تعديل هذه الشروط في أي وقت، وسيُعلن عن أي تغيير جوهري عبر الموقع أو البريد الإلكتروني.",
  },
  {
...
export default function TermsPage() {
  return (
    <PageShell>
      <Helmet title="الشروط والأحكام — رقيم" />
