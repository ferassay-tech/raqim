...
// The template editor is a large, single-route rich content editor opened
// far less often than browsing the template list — worth its own chunk.
const CommunicationTemplateEditorPage = lazy(() => import("./pages/CommunicationTemplateEditorPage"));
