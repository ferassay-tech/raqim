...
import { IconArchive, IconCopy, IconDots, IconPencil, IconTrash } from "@/admin/icons";

interface CommunicationTemplateRowActionsProps {
  onEdit: () => void;
  onDuplicate: () => void;
  onArchive: () => void;
  onDelete: () => void;
...
export function CommunicationTemplateRowActions({
  onEdit,
  onDuplicate,
  onArchive,
  onDelete,
  archived,
}: CommunicationTemplateRowActionsProps) {
